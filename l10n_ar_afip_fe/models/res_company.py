...
class ResCompany(models.Model):
    ...
    l10n_ar_connection_ids = fields.One2many('l10n_ar.afip_fe.connection', 'company_id', 'Connections')

    # Certificate fields
    l10n_ar_afip_fe_environment = fields.Selection([('testing', 'Testing'), ('production', 'Production')], string="AFIP Environment", default='production',
    ...
    def _get_environment_type(self):
        ...
        self.ensure_one()
        if not self.l10n_ar_afip_fe_environment:
